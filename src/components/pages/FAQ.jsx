...
const FAQ = () => {
  ...
  const faqs = [
    {
      question: "What is Nick's Collection?",
      answer: "Nick's Collection is a premium eCommerce clothing store offering the latest in fashion trends for men and women."
    },
    {
      question: "What payment methods do you accept?",
      answer: "We accept all major credit cards, PayPal, Apple Pay, Google Pay, and Afterpay."
    },
    {
    ...
    },
    {
      ...
      answer: "Standard shipping takes 3-5 business days, while express shipping takes 1-3 business days."
    },
    {
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="border-b border-gray-200 pb-4">
                <button
                  ...
                  className="w-full text-left text-lg font-semibold py-2 flex justify-between items-center"
                >
                  {faq.question}
