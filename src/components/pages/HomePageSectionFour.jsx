...
export default function Index() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Here you can add the logic to handle the subscription, e.g., send the email to a server
    setSubscribed(true);
  };
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center xl:space-x-44 lg:space-x-24 space-y-8 lg:space-y-0">
        <div className="md:px-12 lg:px-0 flex flex-col justify-start items-start lg:w-2/5 xl:w-3/12">
          ...
          <div className="xl:mt-6 mt-4">
            <p className="text-base leading-6 text-gray-600">Subscribe to our newsletter to stay in the loop. Our newsletter is sent once a week on every Friday to get the latest news and updates.</p>
          </div>
          {subscribed ? (
